                ...
                <form action="{{ route('resource.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="resource_id" name="resource_id" value="{{ old('resource_id') }}" required>
                            @error('resource_id')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="quantity_total" name="quantity_total" value="{{ old('quantity_total') }}" required>
